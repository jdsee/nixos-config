...
function M.setup()
  ...
  local java_candidates_path = home .. '/.sdkman/candidates/java/'
  config.settings = {
    -- ['java.format.settings.url'] = install_path .. 'java-google-formatter.xml',
    ['java.format.settings.profile'] = 'GoogleStyle',
    java = {
      signatureHelp = { enabled = true };
      -- contentProvider = { preferred = 'fernflower' }; TODO: what is this?
      completion = {
        favoriteStaticMembers = {
          -- TODO: add Collections and AssertJ
      ...
      configuration = {
        runtimes = {
          {
            name = 'Current',
            path = java_candidates_path .. 'current'
          },
          {
            name = 'JavaSE-11',
  ...
  config.cmd = { 'start-jdtls', workspace_folder }
